...
class CommunicationProviderAPDSStageDownload(models.AbstractModel):
	_name = "communication.provider.apds.stage.download"
	_description = "APDS - Etap 1 - Pobranie pliku"
