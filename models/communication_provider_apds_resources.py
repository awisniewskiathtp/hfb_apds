...
class CommunicationLogAPDSResources(models.Model):
    ...
    def _apds_estimate_batch_memory(self, batch_size):
        """
        Szacowanie pamięci pojedynczej porcji.

        To jest punkt, który powinien zostać skalibrowany pomiarem
        rzeczywistego workera na środowisku docelowym.
        """
        # 1 MiB / rekord jako początkowy budżet roboczy.
        # Wartość nie jest twierdzeniem o rzeczywistym zużyciu Odoo.
        return batch_size * 1024 * 1024
